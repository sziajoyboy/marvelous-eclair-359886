...
│   ├── cnzura-xxl.html
│   ├── fekete-giorgo-5-kotelezo.html
│   ├── kepes-interjuk.html
│   ├── offline-dugattyus.html  ← nincs külön case study; a főoldal work/index.html-re linkel
...
│   ├── v7-app.js             ← ✅ v7 patch — törött szelektor-javítások + új szekció animációk
